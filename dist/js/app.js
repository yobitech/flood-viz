...
function initMap() {
  ...
  for (var v in villages) {
    ...
    var villageInfo = new google.maps.InfoWindow({
    	...
    	+ '<br /><br />'
    		+ '<table>'
          +'<tr><td>Air Temperature</td><td>'+village.air_temp+'&deg;C</td></tr>'
          +'<tr><td>Humidity</td><td>'+village.humidity+'%</td></tr>'
          +'<tr><td>Windspeed</td><td>'+village.windspeed+' km/h</td></tr>'
          +'<tr><td>Rainfall</td><td>'+village.rainfall+' atm</td></tr>'
          +'<tr><td>Air Pressure</td><td>'+village.air_pressure+' mm</td></tr>'
          +'<tr><td>Solar radiation</td><td>'+village.solar_radiation+' kw/m<sup>2</sup></td></tr>'
